function [ T_cw] = PositionCamera( T_ow, cameraDistance )
...
%the camera frame. This means that the camera origin will always be
%CameraDistance/2 milimeters away from the Object
CameraOrigin = cameraDistance*(rand(3,1)-[0.5;0.5;0.5]);
