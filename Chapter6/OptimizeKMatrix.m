...
for j = 1:nImages
    ...
    [ KMatJac, FrameJac ] = Jacobian(K, Axis, t, PointsInImage, EquivGrid);
   ...
   %Test for convergence
    ...
    if ChangeInError>0
       ...
       if Gain<1/3
          ...
          for j =1:nImages
               % Computing the Jacobian
                [ KMatJac, FrameJac ] = Jacobian(K, Params{1,1}, Params{1,2}, PointsInImage, EquivGrid);
